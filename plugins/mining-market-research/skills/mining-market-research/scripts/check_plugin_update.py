#!/usr/bin/env python3
"""Parse fixed Git refs and cache a Mining Market Research plugin release state.
...
RELEASE_CHECK_JUSTIFICATION = (
    "允许只读检查 Mining Market Research 的已发布版本吗？"
)
...
def _default_cache_path(platform: str = "codex") -> Path:
    ...
    return (
        ...
        / f"mining-market-research-{platform}-tags-{uid}.json"
    )
