...
- Keep web-sourced narrative separate from Mining Market Research structured market data.
...
- When any of the six Skills is selected for a substantive business request,
  ...
  probe the persistent six-hour success cache, fetch only when due, and reserve
...
- For requested news evidence, use the shared
  [news retrieval workflow](../workflows/news-analysis.md) without reclassification.
